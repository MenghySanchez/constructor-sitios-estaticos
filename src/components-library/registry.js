...
export const componentRegistry = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "buttonLinkType", label: "Tipo de enlace", type: "select", options: ["url", "page"] },
      { name: "buttonUrl", label: "URL boton", type: "text" },
      { name: "buttonPageId", label: "Pagina del proyecto", type: "page" },
      { name: "buttonTarget", label: "Abrir en", type: "select", options: ["_self", "_blank"] },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "linkType", label: "Tipo de enlace", type: "select", options: ["url", "page"] },
      { name: "url", label: "URL", type: "text" },
      { name: "pageId", label: "Pagina del proyecto", type: "page" },
      { name: "target", label: "Abrir en", type: "select", options: ["_self", "_blank"] },
      { name: "align", label: "Alineacion", type: "select", options: ["left", "center", "right"] },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "ctaLinkType", label: "Tipo de enlace CTA", type: "select", options: ["url", "page"] },
      { name: "ctaUrl", label: "URL CTA", type: "text" },
      { name: "ctaPageId", label: "Pagina CTA", type: "page" },
      { name: "ctaTarget", label: "Abrir CTA en", type: "select", options: ["_self", "_blank"] },
    ],
  },
  {
    type: "footer",
